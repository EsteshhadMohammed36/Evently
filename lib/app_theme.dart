...
class AppTheme {
  ...
  static ThemeData dark = ThemeData(
      ...
      textTheme: TextTheme(
        bodyLarge: TextStyle(
            color: backgroundLight, fontSize: 20, fontWeight: FontWeight.w500),
        bodyMedium: TextStyle(
            color: primary, fontSize: 16, fontWeight: FontWeight.bold),
        bodySmall: TextStyle(
            color: greyColor, fontSize: 16, fontWeight: FontWeight.w500),
        displayLarge: TextStyle(
            color: backgroundLight, fontSize: 24, fontWeight: FontWeight.bold),
        displaySmall: TextStyle(
            color: backgroundLight, fontSize: 14, fontWeight: FontWeight.w400),
        displayMedium: TextStyle(
            color: blackColor, fontSize: 16, fontWeight: FontWeight.bold),
      ),
      datePickerTheme: DatePickerThemeData(
